...
import static com.github.tinnan.jobrunner.entity.BatchStepExecutionAdditionalData.TABLE_NAME;
...
@Entity
public class BatchStepExecutionAdditionalData {
    ...
    public static final String COLUMN_ALT_TASK_NAME = "ALT_TASK_NAME";
    ...
    @Column(name = COLUMN_ALT_TASK_NAME)
